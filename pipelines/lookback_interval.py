"""Python Script to compute lookback interval for a given time window."""
import pandas as pd
...
def compute_lookback_interval(df, t, delta1, delta2, mode):
    ...
    if mode == "calendar":
        ...
        backward_window = df[df["Participant_Timestamp_f"].between(t - delta1, t - delta2, inclusive="right")]
